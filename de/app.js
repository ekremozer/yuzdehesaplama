...
function formula1Calculate() {
    ...
    document.getElementById("formula1-result-desc").innerHTML = getAttactment(number, 1) + " %" + getAttactment(percent, 2) + " " + getAttactment(result, 3);
...
function formula2Calculate() {
    ...
    document.getElementById("formula2-result-desc").innerHTML = getAttactment(number, 1) + " %" + percent + " fazlası " + getAttactment(result, 3);
...
function formula3Calculate() {
    ...
    document.getElementById("formula3-result-desc").innerHTML = getAttactment(number, 1) + " %" + percent + " harici " + getAttactment(result, 3);
...
function formula4Calculate() {
    ...
    document.getElementById("formula4-result-desc").innerHTML = getAttactment(number, 1) + " %" + percent + " eksiği " + getAttactment(result, 3);
...
function formula5Calculate() {
    ...
    document.getElementById("formula5-result-desc").innerHTML = number1 + ", " + getAttactment(number2, 1) + " %" + getAttactment(result, 3);
...
function formula6Calculate() {
    ...
    document.getElementById("formula6-result").value = resultToFixed;
    document.getElementById("formula6-result-desc").innerHTML = number1 + ", " + getAttactment(number2, 1) + " %" + resultToFixed + " fazlasıdır";
...
function formula7Calculate() {
    ...
    document.getElementById("formula7-result").value = resultToFixed;
    document.getElementById("formula7-result-desc").innerHTML = number1 + ", " + getAttactment(number2, 1) + " %" + resultToFixed + " eksiğidir";
...
function formula8Calculate() {
    ...
    var result = parseFloat(((percent1 / number) * percent2).toFixed(2));
    var resultToFixed = decimalFix(result);
    var numerToFixed = decimalFix(number);

    document.getElementById("formula8-result").value = resultToFixed;
    document.getElementById("formula8-result-desc").innerHTML = "Yüzde " + getAttactment(percent1, 2) + " " + numerToFixed + " olan sayının %" + getAttactment(percent2, 2) + " " + getAttactment(result, 3);
    document.getElementById("formula8-result-desc").parentElement.style.visibility = "visible";

    if (formulaParameter == true) {
        var formulaText = "((" + percent1 + " / " + number + ") * " + percent2 + ") = " + resultToFixed;
        console.log(formulaText);
    }
}
...
function formula9Calculate() {
    ...
    document.getElementById("formula9-result-desc").innerHTML = number1 + ", " + getAttactment(number2, 1) + " %" + resultToFixed + " haricidir";
...
document.getElementById("formula1-val-2").onkeyup = function(e) {
    var val = document.getElementById("formula1-val-2").value;
    var number = parseFloat(val);
    var attachment = getAttactment(number, 2, true);
    if (attachment == "") {
        document.getElementById("formula1-val-2-attachment").innerHTML = "";
    } else {
        document.getElementById("formula1-val-2-attachment").innerHTML = "'" + attachment;
    }
};

document.getElementById("formula8-val-1").onkeyup = function(e) {
    var val = document.getElementById("formula8-val-1").value;
    var number = parseFloat(val);
    var attachment = getAttactment(number, 2, true);
    if (attachment == "") {
        document.getElementById("formula8-val-1-attachment").innerHTML = "";
    } else {
        document.getElementById("formula8-val-1-attachment").innerHTML = "'" + attachment;
    }
};

document.getElementById("formula8-val-3").onkeyup = function(e) {
    var val = document.getElementById("formula8-val-3").value;
    var number = parseFloat(val);
    var attachment = getAttactment(number, 2, true);
    if (attachment == "") {
        document.getElementById("formula8-val-3-attachment").innerHTML = "";
    } else {
        document.getElementById("formula8-val-3-attachment").innerHTML = "'" + attachment;
    }
};